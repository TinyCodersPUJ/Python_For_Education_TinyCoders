...
class PymataExpress:
    ...
    async def _find_arduino(self):
        ...
        for serial_port in serial_ports:
            ...
            if len(i_am_here) != 62 and len(i_am_here) != 4:
                continue
            ...
            if var_i_am_here != PrivateConstants.I_AM_HERE:
                continue
            else:
                # got an I am here message - is it the correct ID?
                if var_arduino_instance_id == self.arduino_instance_id:
